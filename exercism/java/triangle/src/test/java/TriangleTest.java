...
public class TriangleTest {
    ...
    @Test
    public void testDegeneratedTriangles() throws TriangleException {
        for (int i = 0; i < 1_000_000; i++) {
            double side1 = Math.random() + 0.01;
            double side2 = Math.random() + 0.01;

            Triangle triangle = new Triangle(side1, side2, side1 + side2);
            assertTrue(triangle.isDegenerated());
        }
    }
}
