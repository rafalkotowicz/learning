...
# Step 01:  moving object value assigment to constructor
# Step 02:  simplifying header row creation


class LedgerEntry:
    def __init__(self, date: str, description: int, change: int):
...
def format_entries(currency, locale, entries):
    if locale == 'en_US':
        ...
        # Generate Header Row
        table = 'Datum' + ' ' * 6 + '| Omschrijving' + ' ' * 14 + '| Verandering' + ' ' * 2
